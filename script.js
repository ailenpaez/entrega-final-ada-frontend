document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchCharacters(page) { //^ FUNCIÓN ASINCRÓNICA PARA LEER LA API
        try {
    ...
    function displayCharacters(characters) { //& FUNCIÓN QUE ENCUADRA LOS ELEMENTOS CHARACTERS
    ...
    function updatePaginationButtons() { //? FUNCIÓN PARA BUTTONS DE PAGINADO
    ...
    function changePage(newPage) { //* FC CAMBIAR PÁGINA, LLAMA A LA PRIMERA ASYNC
        currentPage = newPage;
        fetchCharacters(currentPage);
    } //* FIN DE FC QUE CAMBIA DE PAGINA

    async function filterCharactersByGender() { //~ BUSCAR POR GENDER Y VUELVE A PRIMERA PAGINA
    ...
    lastPageBtn.addEventListener("click", () => changePage(Math.ceil(totalCharacters / charactersPerPage)));
